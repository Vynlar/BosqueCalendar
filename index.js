(function() {
  ...
  window.showCalendar = function(id) {
    ...
    return $.each(calendars, function(key, value) {
      if (id === value) {
        console.log("#" + key);
        return top.location.hash = "#" + key;
      }
    });
  };
  ...
  $(document).ready(function() {
    ...
    console.log(hash);
    if ((calendars[hash] != null)) {
      return window.showCalendar(calendars[hash]);
    }
  });
  ...
  $("#root").change(function() {
    ...
    func = (function() {
      switch ($("#root").val()) {
        ...
        case "Upper School Athletics":
          return function() {
            hideAll();
            return $("#USAthletics").show();
          };
        case "Middle School Athletics":
          return function() {
            hideAll();
            return $("#MSAthletics").show();
          };
        ...
        case "Admission Events":
          return function() {
            hideAll();
            return window.showCalendar('bosqueschool.org_r3n867g79oclti23s9neidt2t0@group.calendar.google.com');
          };
        case "Performing Arts":
          return function() {
            hideAll();
            return window.showCalendar('bosqueschool.org_u4u5a97fb4o6qtg00jm346usoc@group.calendar.google.com');
          };
        case "Summer Programs":
          return function() {
            hideAll();
            return window.showCalendar('bosqueschool.org_tq19oilr6d5dmbjn261uconv1o@group.calendar.google.com');
          };
        case "BPA":
          return function() {
            hideAll();
            return window.showCalendar('bosqueschool.org_101b008f4p7s333ld4ell6vpf0@group.calendar.google.com');
          };
      }
    })();
    func();
    return $("#Bosque").change(function() {
      func = (function() {
        switch ($("#Bosque").val()) {
          case "Major Dates":
            return function() {
              return window.showCalendar('bosqueschool.org_76to4kr5lb2j1an0a47idm156k@group.calendar.google.com');
            };
          case "10-Day Rotation":
            return function() {
              return window.showCalendar('bosqueschool.org_hvg4ot93r37bmfhfc8icjflbj8@group.calendar.google.com');
            };
          case "Lunch":
            return function() {
              return window.showCalendar('bosqueschool.org_3hme67a2fiq3kehqlpj40r0g7s@group.calendar.google.com');
            };
          case "School Closures":
            return function() {
              return window.showCalendar('bosqueschool.org_6a03jg89qcheos0st276c32kec@group.calendar.google.com');
            };
          case "Special Events":
            return function() {
              return window.showCalendar('bosqueschool.org_jvcae42sckldksbt2q2qnkrff4@group.calendar.google.com');
            };
          case "Intercultural Exchange":
            return function() {
              return window.showCalendar('bosqueschool.org_a7aqnk9em72i33o0fko7dhu1ho@group.calendar.google.com');
            };
          case "Upper School":
            return function() {
              return window.showCalendar('bosqueschool.org_ihpomq8egbvmfsf1ke1r607cqk@group.calendar.google.com');
            };
          case "Middle School":
            return function() {
              return window.showCalendar('bosqueschool.org_p9nalksq6so969kj2ltcjftmo4@group.calendar.google.com');
            };
          case "Middle School Field Trips":
            return function() {
              return window.showCalendar('bosqueschool.org_ln1bl1ooj2e2o1kr6grhk7jrfs@group.calendar.google.com');
            };
        }
      })();
      return func();
  ...
  $("#USAthletics").change(function() {
    var func;
    func = (function() {
      switch ($("#USAthletics").val()) {
        case "Boys Tennis":
          return function() {
            return window.showCalendar('bosqueschool.org_rt1vcc7pfgktguhnt2n6honmm8@group.calendar.google.com');
          };
        case "Girls Tennis":
          return function() {
            return window.showCalendar('bosqueschool.org_saabcnnpfgq202p0vqk0uo0ugk@group.calendar.google.com');
          };
        case "Boys Basketball":
          return function() {
            return window.showCalendar('bosqueschool.org_1dqfafsbr5je2iasbq8is5s2b0@group.calendar.google.com');
          };
        case "Girls Basketball":
          return function() {
            return window.showCalendar('bosqueschool.org_gj9reb6e8gauubvjq3ilmcvtdc@group.calendar.google.com');
          };
        case "Girls Lacrosse":
          return function() {
            return window.showCalendar('bosqueschool.org_lng8hpv4ohko7eh3iichmnp5cg@group.calendar.google.com');
          };
        case "Boys Lacrosse":
          return function() {
            return window.showCalendar('bosqueschool.org_gcoo8g9euacnrc3brfmod36l98@group.calendar.google.com');
          };
        case "Girls Soccer":
          return function() {
            return window.showCalendar('bosqueschool.org_vm67grg4fq7fqapgi1pve5gprk@group.calendar.google.com');
          };
        case "Boys Soccer":
          return function() {
            return window.showCalendar('bosqueschool.org_m3q3nto7qtt7n37sunnjsgaoe4@group.calendar.google.com');
          };
        case "Golf":
          return function() {
            return window.showCalendar('bosqueschool.org_9q6ccnbv3rberbsbp0gogsalic@group.calendar.google.com');
          };
        case "Swimming":
          return function() {
            return window.showCalendar('bosqueschool.org_gn2dllui9rp9ut40q16sdpv89s@group.calendar.google.com');
          };
        case "Track":
          return function() {
            return window.showCalendar('bosqueschool.org_hcbpou8h8s4j48jp1qr29u14to@group.calendar.google.com');
          };
        case "Cross Country":
          return function() {
            return window.showCalendar('bosqueschool.org_t2nh5qnongbvdn5p6gvcp0nsdg@group.calendar.google.com');
          };
        case "Volleyball":
          return function() {
            return window.showCalendar('bosqueschool.org_95cfs8tkgbfhjbp1a8vdj1t6f4@group.calendar.google.com');
          };
      }
    })();
    return func();
  ...
  $("#MSAthletics").change(function() {
    var func;
    func = (function() {
      switch ($("#MSAthletics").val()) {
        case "Girls Basketball":
          return function() {
            return window.showCalendar('bosqueschool.org_7sb44g06j2kcah9g51gmbk6h8o@group.calendar.google.com');
          };
        case "Boys Basketball":
          return function() {
            return window.showCalendar('bosqueschool.org_areprtapq8d6ijo57nao7drk38@group.calendar.google.com');
          };
        case "Girls Soccer":
          return function() {
            return window.showCalendar('bosqueschool.org_dadgjj7sn6h95748vc7j1h98k0@group.calendar.google.com');
          };
        case "Boys Soccer":
          return function() {
            return window.showCalendar('bosqueschool.org_pd9o60bcp8nbe905fip6k0t95k@group.calendar.google.com');
          };
        case "Cross Country":
          return function() {
            return window.showCalendar('bosqueschool.org_76r2rj3cmiv38rfmebnofi36rg@group.calendar.google.com');
          };
        case "Tennis":
          return function() {
            return window.showCalendar('bosqueschool.org_uq00q1kven6gvlkslpajvvijog@group.calendar.google.com');
          };
        case "Track":
          return function() {
            return window.showCalendar('bosqueschool.org_dviim4pro7vvi675vgok51c2t8@group.calendar.google.com');
          };
        case "Volleyball":
          return function() {
            return window.showCalendar('bosqueschool.org_4m11oit5m7avthkoupsfg5g7lc@group.calendar.google.com');
          };
      }
    })();
    return func();
  ...
  $("#College").change(function() {
    ...
    func = (function() {
      switch ($("#College").val()) {
        case "Special Events":
          return function() {
            return showCalendar('bosqueschool.org_s16jjc81n2sjaadnvfg6ei66k8@group.calendar.google.com');
          };
        case "College Visits":
          return function() {
            return showCalendar('bosqueschool.org_6jgqiet9p6m3182cocac7p3v38@group.calendar.google.com');
          };
      }
    })();
    return func();
